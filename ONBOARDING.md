...
- **Solar Cycle**: Core unit of time for GPS workers. Matches to the time it takes the local HUB to travel around the local star. Often shortened to **cycle** See also: quad, ray
- **Solar Ray**: 1/32 of a Solar Cycle. Often shortened to **ray**. Shortened to **s-ray** for official distinction between a planet or comet cycle.
- **Solar Quad**: Quadrant fractional unit of time. Equates to the which set of rays the local HUB is currently in. Quadrants change at the point at which the HUB is closest and farthest from the local star as well as the mid-cycle parallel. See Solar Calendar Reference for additional information.
- **Solar Rotation**: Core unit of time for GPS workers. Matches to the time it takes the local HUB to rotate completely around itself. Often shortened to **grot**. See also frac, flit, splint, spec
- **Frac**: Initial fraction of a planetary, comet, or HUB rotation. 1/8 of the rotation unit.
- **Flit**: 1/8 of a frac.
...
>| Ray | Name | Detail |
>| --- | --- | --- |
>| 0 | *Zenith* | Closest point to the local star |
>| 0 - 7 | Dull Quad | Light to midpoint (Shrouded) |
>| 8 | *Umbra* | Midpoint leaving star |
>| 8 - 15 | Gloom Quad | Midpoint to dark (Shrouded) |
>| 16 | *Nadir* | Farthest point from the star |
>| 16 - 23 | Dim Quad | Dark to midpoint (Ignited) |
>| 24 | *Penumbra* | Midpoint approaching star |
>| 24 - 31 | Bloom Quad | Midpoint to light (Ignited) |
